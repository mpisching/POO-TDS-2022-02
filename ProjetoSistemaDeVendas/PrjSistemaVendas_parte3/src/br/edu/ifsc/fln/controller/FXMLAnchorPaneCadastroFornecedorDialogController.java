...
public class FXMLAnchorPaneCadastroFornecedorDialogController implements Initializable {
    ...
    public void handleBtConfirmar() {
        if (validarEntradaDeDados()) {
            //condição para verificar se trata da atualização ou de um novo fornecedor. 
            //Sendo novo, verifica qual é o tipo de fornecedor para fazer a instanciação apropriada. 
            if (this.fornecedor == null) {
                if (rbNacional.isSelected()) {
                    this.fornecedor = new Nacional();
                } else {
                    this.fornecedor = new Internacional();
                }
            }
